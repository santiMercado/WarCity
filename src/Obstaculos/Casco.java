...
public class Casco extends PowerUp implements Runnable {
 ...
 protected Thread hilo;
	public Casco(int x, int y, Juego g) {
		...
		graf.addImage(0, new ImageIcon(GUI.class.getResource("/Graficos/Casco.png")));
		graf.addImage(1, new ImageIcon(GUI.class.getResource("/Graficos/Casco.png")));
		graf.addImage(2, new ImageIcon(GUI.class.getResource("/Graficos/Casco.png")));
		graf.addImage(3, new ImageIcon(GUI.class.getResource("/Graficos/Casco.png")));
		graf.setImage(0);
